        ...
        <v-row no-gutters justify="space-around">
            <v-col cols="12" md="6" lg="6" xl="6" class="d-flex justify-center" >
                <div id="imageDom" ref="imageDom" class="box-custom-image2">
                    <img id="imgFood" ref="imgFood" src="../assets/template4-back.png" height="600" width="600" class="image-food">
                    <div class="content-top">
                        <img id="imgGradient" ref="imgGradient" src="../assets/blackGradient.png"  class="gradient" />
                        <img id="imgTopLeft" ref="imgTopLeft" src="../assets/template1-top-left.png"  class="top-left" />
                        <img ref="qr" :src="qr" class="qr">
                        <img ref="imgTopLeft" src="../assets/template4-top-right.png"  class="top-right" />
                    </div>
            ...
            <v-col cols="12" md="6" lg="6" xl="6"  class="d-flex justify-center">
                <div class="parent">
                    ...
                    <div class="div5">
                        <a href="/files/FPD_Promote_Store_New.ai" download="FPD_Promote_Store_New.ai"><v-btn class="white--text" color="#d70f64" style="margin-right:5px; margin-left:5px; width:100%;" :style="{'font-size': fontSize}">ดาวน์โหลด AI</v-btn></a>
                    </div>
                    <div class="div6">
...
export default {
    ...
    data: () => ({
        ...
        isSaving: false,
        restaurantName: 'ร้านซูชิหน้ามอ',
        caption: 'สดใหม่ คำใหญ่แน่นอน',
        qr: null,
    }),
    mounted() {
        let url = '';
            ...
            this.generateImage().then(() => {
                this.generateImage().then(() => {
                    this.generateImage().then((blob) => {
                        saveAs(blob, 'FPD_Promote_Store_New.png');
                        this.isSaving = false;
                    })
                })
            })
