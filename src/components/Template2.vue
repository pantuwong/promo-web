        ...
        <v-row no-gutters justify="space-around">
            <v-col cols="12" md="6" lg="6" xl="6" class="d-flex justify-center" >
                <div ref="imageDom" class="box-custom-image2">
                    <img ref="imgFood" src="../assets/template2-back.png" height="600" width="600" class="image-food">
                    ...
                    <div class="content-bottom">
                        <img ref="imgBottomRight" src="../assets/template2-bottom-right.png"  class="bottom-right" />
