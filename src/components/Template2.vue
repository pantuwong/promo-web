        ...
        <v-row no-gutters justify="space-around">
            <v-col cols="12" md="6" lg="6" xl="6" class="d-flex justify-center" >
                <div id="imageDom" ref="imageDom" class="box-custom-image2">
                    <img id="imgFood" ref="imgFood" src="../assets/template2-back.png" height="600" width="600" class="image-food">
                    ...
                    <div class="content-bottom">
                        <img id="imgBottomRight" ref="imgBottomRight" src="../assets/template2-bottom-right.png"  class="bottom-right" />
            ...
            <v-col cols="12" md="6" lg="6" xl="6"  class="d-flex justify-center">
                <div class="parent">
                    ...
                    <div class="div7">
                        <a href="/files/FPD_Recom_Menu.ai"  download="FPD_Recom_Menu.ai"><v-btn class="white--text" color="#d70f64" style="margin-right:5px; margin-left:5px; width:100%;"  :style="{'font-size': fontSize}">ดาวน์โหลด AI</v-btn></a>
                    </div>
                    <div class="div8">
...
export default {
    ...
    data: () => ({
        ...
        isSaving: false,
        restaurantName: 'ร้านไก่ต๊อกต๊อก',
        restaurantBranch: 'สาขาทองหล่อ',
        menuName: 'ข้าวมันไก่สิงคโปร์',
        qr: null,
    }),
    mounted() {
        let url = '';
            ...
            this.generateImage().then(() => {
                this.generateImage().then(() => {
                    this.generateImage().then((blob) => {
                        saveAs(blob, 'FPD_Recom_Menu.png');
                        this.isSaving = false;
                    })
                })
            })
