        ...
        <v-row no-gutters justify="space-around">
            <v-col cols="12" md="6" lg="6" xl="6" class="d-flex justify-center" >
                <div id="imageDom" ref="imageDom" class="box-custom-image2">
                    <img id="imgFood" ref="imgFood" src="../assets/template9-back.png" height="600" width="600" class="image-food">
                    ...
                    <div class="content-bottom">
                        <img id="imgBottomRight" ref="imgBottomRight" src="../assets/template9-bottom-right.png"  class="bottom-right" />
            ...
            <v-col cols="12" md="6" lg="6" xl="6"  class="d-flex justify-center">
                <div class="parent">
                    ...
                    <div class="div5">
                        <v-text-field ma-2 v-model="max" label="สูงสุด" ></v-text-field>
                    </div>
                    <div class="div4">
                    ...
                    <div class="div8">
                        <v-btn href="/files/FPD_Discount_Shops1.ai" class="white--text" color="#d70f64" style="margin-right:5px; margin-left:5px; width:100%;" >ดาวน์โหลด Ai</v-btn>
                    </div>
                    <div class="div9">
