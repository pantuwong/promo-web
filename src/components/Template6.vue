        ...
        <v-row no-gutters justify="space-around">
            ...
            <v-col cols="12" md="6" lg="6" xl="6"  class="d-flex justify-center">
                <div class="parent">
                    ...
                    <div class="div5">
                        <a href="/files/FPD_Promote_Store_Hot.ai" download="FPD_Promote_Store_Hot.ai"><v-btn class="white--text" color="#d70f64" style="margin-right:5px; margin-left:5px; width:100%;" :style="{'font-size': fontSize}">ดาวน์โหลด AI</v-btn></a>
                    </div>
                    <div class="div6">
    ...
    methods: {
        ...
        toImage() {
            ...
            this.generateImage().then(() => {
                this.generateImage().then(() => {
                    this.generateImage().then((blob) => {
                        saveAs(blob, 'FPD_Promote_Store_Fast.png');
                        this.isSaving = false;
                    })
                })
            })
            ...
            let data = JSON.stringify({
                ...
                template_name: 'FPD_Promote_Store_Fast',
                email: this.email
            });
