        ...
        <v-row no-gutters justify="space-around">
            <v-col cols="12" md="6" lg="6" xl="6" class="d-flex justify-center" >
                <div id="imageDom" ref="imageDom" class="box-custom-image2">
                    <img id="imgFood" ref="imgFood" src="../assets/template7-back.png" height="600" width="600" class="image-food">
                    ...
                    <div class="content-bottom">
                        <img id="imgBottomRight" ref="imgBottomRight" src="../assets/template7-bottom-right.png"  class="bottom-right" />
            ...
            <v-col cols="12" md="6" lg="6" xl="6"  class="d-flex justify-center">
                <div class="parent">
                    ...
                    <div class="div9">
                        <a href="/files/FPD_BOGO.ai" download="FPD_BOGO.ai"><v-btn class="white--text" color="#d70f64" style="margin-right:5px; margin-left:5px; width:100%;" :style="{'font-size': fontSize}">ดาวน์โหลด AI</v-btn></a>
                    </div>
                    <div class="div10">
...
.div3 { grid-area: 2 / 5 / 3 / 7; }
.div4 { grid-area: 3 / 1 / 4 / 7; }
.div5 { grid-area: 4 / 1 / 5 / 3; }
.div6 { grid-area: 4 / 5 / 5 / 7; }
.div7 { grid-area: 5 / 1 / 6 / 7; }
.div8 { grid-area: 6 / 1 / 7 / 2; }
.div9 { grid-area: 6 / 3 / 7 / 5; }
.div10 { grid-area: 6 / 6 / 7 / 7; }
