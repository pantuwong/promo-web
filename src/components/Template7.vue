        ...
        <v-row no-gutters justify="space-around">
            ...
            <v-col cols="12" md="6" lg="6" xl="6"  class="d-flex justify-center">
                <div class="parent">
                    ...
                    <div class="div9">
                        <v-btn href="/files/FPD_BOGO.ai" class="white--text" color="#d70f64" style="margin-right:5px; margin-left:5px; width:100%;" :style="{'font-size': fontSize}">ดาวน์โหลด AI</v-btn>
                    </div>
                    <div class="div10">
